    ...
    <head>
        ...
        <style>    
            ...
            *{margin:0;padding:0;font-family:"Malgun Gothic","맑은 고딕",Dotum,"돋움",Arial,sans-serif}
            ...
            .btncalendar{display:inline-block;width:22px;height:22px;background:url('../images/order/calendar1.jpg') center center no-repeat;text-indent:-999em}
        ...
        $(document).ready(function() {
            ...
            $('#searchEndDate').datepicker('setDate', new Date);
