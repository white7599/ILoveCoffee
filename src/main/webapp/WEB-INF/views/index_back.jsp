                ...
                <section>
                    <div class="list_page">
                        ...
                        <div class="list_title">
                            <h3> &nbsp;원두
                                <!--<span>&nbsp;<input type="button" value="More" class="btn"></span>-->
                            </h3>
                        </div>
                                    ...
                                    <a href="detail">
                                        <figure>
                                            ...
                                            <figcaption>
                                                <h5>[생두] 파나마</h5>
                                                <h6>게이샤 워시드 & 내추럴</h6>
                                                Aroma & Flavor orange, cherry, black tea, cane sugar Acidity citric
                                                Other silky
                                            </figcaption>
                                        </figure>
                                    </a>
                                    ...
                                    <a href="detail">
                                        <figure>
                                            ...
                                            <figcaption>
                                                <h5>[생두] 에티오피아</h5>
                                                <h6>구지 오도 샤키소</h6>
                                                Aroma & Flavor rasberry, apricot jam, jasmine, honey Acidity complex
                                                Other long finish
                                            </figcaption>
                                        </figure>
