...
public class PageMaker {
	...
	private Criteria cri;	//page(현재 페이지), perPageNum(페이지 당 보여질 게시물수)
	...
	public String makeQuery(int page) {
		UriComponentsBuilder uriComponentsBuilder = UriComponentsBuilder.newInstance()
			...
			if (this.cri.getSearchType() != null) {
				...
				if(this.cri.getSearchStartDate() != null) {
					uriComponentsBuilder
						.queryParam("searchStartDate", this.cri.getSearchStartDate())
						.queryParam("searchEndDate", this.cri.getSearchEndDate());
				}
			}
